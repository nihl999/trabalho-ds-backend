...
export class migration1689648380236 implements MigrationInterface {
  name = 'migration1689648380236'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        `)
    await queryRunner.query(`
            CREATE TYPE "public"."inventario_status_enum" AS ENUM('0', '1', '2')
        `)
    await queryRunner.query(`
            CREATE TABLE "inventario" (
                ...
                "espacosInventarioEspacoId" character varying,
                "espacosInventarioInventarioId" integer,
    ...
    await queryRunner.query(`
            CREATE TABLE "patrimonios" (
                ...
                "espacoInventarioInventarioId" integer,
                "responsavelId" integer,
                CONSTRAINT "PK_e03c9e66217af03fe5b83cbb367" PRIMARY KEY ("numero", "espacoInventarioInventarioId")
            )
        `)
    await queryRunner.query(`
    ...
    await queryRunner.query(`
            ALTER TABLE "inventario"
            ADD CONSTRAINT "FK_ae59e96de915190a2c391034e50" FOREIGN KEY (
                    "espacosInventarioEspacoId",
                    "espacosInventarioInventarioId"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `)
    await queryRunner.query(`
            ALTER TABLE "inventario" DROP CONSTRAINT "FK_ae59e96de915190a2c391034e50"
        `)
    await queryRunner.query(`
